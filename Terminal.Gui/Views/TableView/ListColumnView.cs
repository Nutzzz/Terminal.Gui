...
namespace Terminal.Gui {
	...
	public partial class ListColumnView : TableView {
		...
		public class ListColumnStyle {
			...
			/// <summary>
			/// Gets or sets a flag indicating whether there should be a horizontal line before all the data
			/// in the table. Defaults to <see langword="false"/>.
			/// </summary>
			//public bool ShowHorizontalTopline { get; set; } = false;
